// Include the header file of the libary.
#include "STM32_System_Init.h"

// Block variable if the FMC already initialized or de-initialized.
...
{
    myUART.println("MX_LTDC_Init");
    // Got all this from STM32CubeIDE.
    ...
    pLayerCfg.FBStartAdress = STM32_LTDC_LAYER1_ADDR;
    ...
    pLayerCfg1.FBStartAdress = STM32_LTDC_LAYER2_ADDR;
...
void MX_FMC_Init(void)
{
    ...
    HAL_SDRAM_ProgramRefreshRate(&hsdram1, 1563);
...
{
    myUART.println("HAL_LTDC_MspInit");
    ...
    if (hltdc->Instance == LTDC)
    {
        ...
        */
        ...
        GPIO_InitStruct.Pin = LCD_B1_Pin | LCD_B2_Pin | LCD_B3_Pin | LCD_G4_Pin | LCD_G1_Pin | LCD_G3_Pin | LCD_G0_Pin |
                              LCD_G2_Pin | LCD_R7_Pin | LCD_R5_Pin | LCD_R6_Pin | LCD_R4_Pin | LCD_R3_Pin | LCD_R1_Pin |
                              LCD_R2_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
        ...
        GPIO_InitStruct.Pin = LCD_DE_Pin | LCD_B7_Pin | LCD_B6_Pin | LCD_B5_Pin | LCD_G6_Pin | LCD_G7_Pin | LCD_G5_Pin;
        GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
        GPIO_InitStruct.Pull = GPIO_NOPULL;
        GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
        GPIO_InitStruct.Alternate = GPIO_AF14_LTDC;
...
{
    myUART.println("HAL_LTDC_MspDeInit");
    if (hltdc->Instance == LTDC)
    {
        ...
        */
        ...
        HAL_GPIO_DeInit(GPIOJ, LCD_B1_Pin | LCD_B2_Pin | LCD_B3_Pin | LCD_G4_Pin | LCD_G1_Pin | LCD_G3_Pin |
                                   LCD_G0_Pin | LCD_G2_Pin | LCD_R7_Pin | LCD_R5_Pin | LCD_R6_Pin | LCD_R4_Pin |
                                   LCD_R3_Pin | LCD_R1_Pin | LCD_R2_Pin);

        HAL_GPIO_DeInit(GPIOK,
                        LCD_DE_Pin | LCD_B7_Pin | LCD_B6_Pin | LCD_B5_Pin | LCD_G6_Pin | LCD_G7_Pin | LCD_G5_Pin);
...
{
    myUART.println("HAL_FMC_MspInit");
    GPIO_InitTypeDef GPIO_InitStruct = {0};
    if (FMC_Initialized)
    {
        return;
    ...
    myUART.println("Must do the init");
    ...
    PE13   ------> FMC_D10
    */
    GPIO_InitStruct.Pin = FMC_NBL1_Pin | FMC_NBL0_Pin | FMC_D5_Pin | FMC_D6_Pin | FMC_D8_Pin | FMC_D11_Pin |
                          FMC_D4_Pin | FMC_D7_Pin | FMC_D9_Pin | FMC_D12_Pin | FMC_D10_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    ...
    GPIO_InitStruct.Pin = FMC_A0_Pin | FMC_A1_Pin | FMC_A2_Pin | FMC_A3_Pin | FMC_A4_Pin | FMC_A5_Pin | FMC_A6_Pin |
                          FMC_A9_Pin | FMC_A7_Pin | FMC_A8_Pin | FMC_SDNRAS_Pin;
    GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
    GPIO_InitStruct.Pull = GPIO_NOPULL;
    GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
    GPIO_InitStruct.Alternate = GPIO_AF12_FMC;
...
{
    myUART.println("HAL_SDRAM_MspInit");
    HAL_FMC_MspInit();
}

extern "C" void HAL_FMC_MspDeInit(void)
{
    myUART.println("HAL_FMC_MspDeInit");
    ...
    PE13   ------> FMC_D10
    */
    HAL_GPIO_DeInit(GPIOE, FMC_NBL1_Pin | FMC_NBL0_Pin | FMC_D5_Pin | FMC_D6_Pin | FMC_D8_Pin | FMC_D11_Pin |
                               FMC_D4_Pin | FMC_D7_Pin | FMC_D9_Pin | FMC_D12_Pin | FMC_D10_Pin);
    ...
    HAL_GPIO_DeInit(GPIOF, FMC_A0_Pin | FMC_A1_Pin | FMC_A2_Pin | FMC_A3_Pin | FMC_A4_Pin | FMC_A5_Pin | FMC_A6_Pin |
                               FMC_A9_Pin | FMC_A7_Pin | FMC_A8_Pin | FMC_SDNRAS_Pin);
...
{
    myUART.println("HAL_SDRAM_MspDeInit");
    HAL_FMC_MspDeInit();
}

DMA_HandleTypeDef *getDMAInstance()
{
    return &hdma_memtomem_dma2_stream0;
}
